...
void RegistScene::onEnter(){
    ...
    //根Panel
    UIPanel* rootReferee = (UIPanel*)addshow->getChildByTag(305);
    UIPanel* rootPhone = (UIPanel*)addshow->getChildByTag(395);
    UIPanel* rootVerify = (UIPanel*)addshow->getChildByTag(374);
...
//    UIPanel* setup1 = (UIPanel*)addshow->getChildByTag(20);
    UIPanel* setup2 = (UIPanel*)addshow->getChildByTag(44)->getChildByTag(416);
    UIPanel* setupReferee = (UIPanel*)addshow->getChildByTag(305)->getChildByTag(344);
...
//    }
    ...
    /*** 按钮 ***/
    //推荐人确定按钮
    m_reffereeBtn =(UIButton*)setupReferee->getChildByTag(314);
...
//    m_registBtn->addTouchEventListener(this,toucheventselector(RegistScene::registPress));
    //完成注册按钮
    UIButton* m_finishBtn = (UIButton*)setup2->getChildByTag(94);
    ...
    //确认发送短信
    UIButton* m_cfmOkBtn = (UIButton*)addshow->getChildByTag(466)->getChildByTag(467)->getChildByTag(474);
    m_cfmOkBtn->addTouchEventListener(this, toucheventselector(RegistScene::cfmOkPress));
    //取消发送短信
    UIButton* m_cfmCancelBtn = (UIButton*)addshow->getChildByTag(466)->getChildByTag(467)->getChildByTag(473);
    ...
    //性别复选框
    UICheckBox* manCheckBox = (UICheckBox*)addshow->getChildByTag(44)->getChildByTag(416)->getChildByTag(224);
    UICheckBox* WomCheckBox = (UICheckBox*)addshow->getChildByTag(44)->getChildByTag(416)->getChildByTag(227);
...
//	m_cfmPassWord->setTouchPriority(0);
    ...
    m_itrsPhoneNum->setPosition(ccp(refereePoint.x + 20, refereePoint.y - 15));
    ...
    m_phoneNum->setPosition(ccp(phonePoint.x + 20, phonePoint.y - 15));
    ...
    m_verityNum->setPosition(ccp(verifyPoint.x + 20, verifyPoint.y - 15));
    
    //密码
    UIImageView* passwordLiImage = (UIImageView*)setup2->getChildByTag(172);
...
//        pUserService->phoneNum(v_phoneNum, refereeIdItem, this, MyHttpResp(&RegistScene::vphoneEnd));
        ...
        UILabel* phoneLable = (UILabel*)rootConfirm->getChildByTag(467)->getChildByTag(505);
...
void RegistScene::finishPress( CCObject *pSender,TouchEventType type )
{
	...
	if (type == TOUCH_EVENT_ENDED)
	{
		...
		UserService* pUserService = (UserService*)ServiceCenter::getInstance()->getService(ServiceCenter::USER_SERVICE);
		pUserService->setPerfect(useridItem,m_realName->getText(), m_gender, m_areaBox->getText(), likeItem, this, MyHttpResp(&RegistScene::setPerfectEnd));
...
void RegistScene::showPanel(int setup){
    ...
    if(setup == 1){
        ...
        coverView = CoverView::create(CCRect(70,v_height - 960 + 690,500,400), CCSize(127, 127), 180, 0.25f);
        coverView->setPosition(70,690);
...
//            player->setContentSize(CCSize(127,127));
        ...
        UIPanel* setup2 = (UIPanel*)rootPerfect->getChildByTag(416);
        ...
        //账号label
        UILabel* usernameLabel = (UILabel*)addshow->getChildByTag(44)->getChildByTag(416)->getChildByTag(179)->getChildByTag(187);
